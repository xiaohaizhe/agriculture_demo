        ...
        methods: {
            async drawChart(){
                ...
                let option = {
                    ...
                    series: [{
                        data: [0,0,3047.49,3164.91,3367.28,3581.36,3629.81,3735.39,3889.9,4039.33,4139],
                        type: 'bar',
                        name:'产量（万吨）',
                        barMaxWidth :20,
                        itemStyle: {
                        ...
                        data: [0,1992.26,2049.11,2139.94,2177.32,2231.35,2272.2,2272.2,2328.3,2323.8,0],
                        type: 'bar',
                        name:'种植面积（千公顷）',
                        barMaxWidth :20,
                        itemStyle: {
